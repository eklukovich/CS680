...
bool shader::setupShader(char * fileName){
...
const char * shader::readShaderFile(char * fileName){
...
GLint shader::compileShader(const char * shaderSrc){

    // initialize variables
       GLint shader_status; 

    // Vertex shader first
       glShaderSource(shaderData, 1, &shaderSrc, NULL);
